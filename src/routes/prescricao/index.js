...
module.exports = (Prescricao, Cuidado, Dieta, Acolhido, router) => {
  ...
  router.get('/acolhido/:acolhido_id/prescricao/:prescricao_id/edit', edit(Prescricao, Cuidado, Dieta, Acolhido))
